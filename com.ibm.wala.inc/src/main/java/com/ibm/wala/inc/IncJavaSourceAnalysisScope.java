...
public class IncJavaSourceAnalysisScope extends JavaSourceAnalysisScope {
	public static final ClassLoaderReference INCREMENTAL = new ClassLoaderReference(
			Atom.findOrCreateUnicodeAtom("Incremental"), Atom.findOrCreateAsciiAtom("Java"),
	...
	protected void initIncremental() {
		ClassLoaderReference incremental = new ClassLoaderReference(INCREMENTAL.getName(), INCREMENTAL.getLanguage(),
				loadersByName.get(APPLICATION));
