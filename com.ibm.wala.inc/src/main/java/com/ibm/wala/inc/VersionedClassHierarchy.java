...
public class VersionedClassHierarchy extends ClassHierarchy {
	...
	public VersionedClassHierarchy(VersionedClassHierarchy previous, AnalysisScope scope, ClassLoaderFactory factory,
		...
		while (it.hasNext()) {
			...
			if (k instanceof JavaClass) {
				...
				System.out.println("classs in vcha " + klass.getSourceURL().toString());
			}
		}
